...
class Config(Config):
  TG_BOT_TOKEN = "1287349352:AAE5kpUUv5La3JDxfl2SFpl3SHu0dcqrOzw"
  APP_ID = 1878625
  ...
  YTDL_COMMAND = "ytdl@abir_leeching_bot"
  LEECH_COMMAND = "leech@abir_leeching_bot"
  CLEAR_THUMBNAIL = "clearthumbnail@abir_leeching_bot"
  SAVE_THUMBNAIL = "savethumbnail@abir_leeching_bot"
  OWNER_ID = 715779594
...
team_drive = 1rWomzK1yVjkqIbC9p9EBBKJgcf3imGr4"""
  DESTINATION_FOLDER = ""
  GLEECH_COMMAND = "gleech@abir_leeching_bot"
