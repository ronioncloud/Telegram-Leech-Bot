...
class Config(Config):
  TG_BOT_TOKEN = "1400992374:AAHEvgKn7FpZrr6rlAJbV4CYl2aKo42LHaU"
  APP_ID = 1878625
  API_HASH = "3ab3e48ba126de2eb96ffff39b18fa09"
  AUTH_CHANNEL = [-1001256038785, -1001408445549, -1001398883981, -1001275361660, 715779594, 1161316820, 1291911714]
  INDEX_LINK = "https://tgindex.hackitabirhasan.workers.dev/3:/Trash"
  YTDL_COMMAND = "ytdl"
  LEECH_COMMAND = "leech"
